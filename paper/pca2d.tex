...
(Table~\ref{tab:campaigns}), yet the correction removes more than half of the
velocity scatter of one and adds to the other's. The two brighter campaigns,
whose spectra have four to six times that signal-to-noise, are the ones where
the correction has the least to remove.
